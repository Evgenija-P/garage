...
const ContactUs = () => {
  return (
    <section className="relative min-h-[400px] w-full bg-secondary-lite bg-[url('/images/contact-us-mob.png')] bg-size-[100%_auto] bg-center bg-no-repeat md:pt-0 xl:bg-size-[100%_auto]">
